...
description: "Voicemetrics is a white-label Voice AI SaaS platform built specifically for AI automation agencies. It lets you launch your own branded AI voice platform—powered by Retell AI, Vapi, Ultravox, Eleven Labs, and more—without writing any code. You get full control of the brand, pricing, and client experience, while Voicemetrics powers the technology behind the scenes."
---

![Intro2 Jp](/images/intro2.jpg)
...
<CardGroup cols={2}>
  ...
  <Card title="Rapid Deployment" icon="truck-fast" color="#034737">
    - Launch a branded agent for your clients in under 30 minutes with greater efficiency.
  </Card>
