...
<CardGroup cols={2}>
  <Card title="Sell As Your Brand" icon="microchip-ai" color="#034737">
  ...
  <Card title="Launch in Minutes " icon="rocket-launch" color="#034737">
  ...
  <Card title="Ongoing Support" icon="head-side-headphones" color="#034737">
