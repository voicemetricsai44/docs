---
title: "About Voicemetrics"
description: "Voicemetrics is a white-label Voice AI SaaS platform built specifically for AI automation agencies.
...
<CardGroup cols={2}>
  <Card title="Fully White-Labeled" icon="sparkles">
    -  Use your own logo, domain, colors, and branding across the entire platform.
  </Card>
  <Card title="No-Code Voice Agent Builder" icon="sparkles">
    - Build and deploy AI voice agents for inbound/outbound calls—no technical skills.
  </Card>
  <Card title="Plug & Play Voice Provider Integration" icon="sparkles">
    -  Instantly connect with Retell AI, Vapi (and soon Ultravox & Eleven Labs).
  </Card>
  <Card title="Rebilling System" icon="sparkles">
    - Set your subscription plans, add call usage markups, and automate billing.
  </Card>
  <Card title="Rapid Deployment" icon="sparkles">
    - Launch a branded agent for your clients in under 30 minutes.
  </Card>
  <Card title="Flexible Automation Workflows" icon="sparkles">
...
<CardGroup cols={2}>
  <Card title="Sell Voice AI Under Your Own Brand" icon="sparkles">
    -  Full white-label control. Your logo, domain, pricing, and customer experience.
  </Card>
  <Card title="Keep 100% of the Profits" icon="sparkles">
  ...
  <Card title="Launch in Minutes, Not Weeks" icon="sparkles">
    - Start offering AI agents to your clients in less than 30 minutes.
  </Card>
  <Card title="Scalable Infrastructure" icon="sparkles">
    - Serve unlimited clients and voice agents as your agency grows.
  </Card>
  <Card title="Ongoing Strategic Support" icon="sparkles">
