...
<CardGroup cols={2}>
  ...
  <Card title="Plug & Play Voice Provider Integration" icon="plug-circle-bolt" color="#034737">
...
<CardGroup cols={2}>
  <Card title="Sell Voice AI Under Your Own Brand" icon="microchip-ai" color="#034737">
