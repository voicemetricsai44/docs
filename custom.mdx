...
A custom domain allows you to deliver a fully branded experience to your clients by hosting the platform under your agency’s domain (e.g., app.youragency.com). This enhances professionalism, builds trust, and keeps your brand front and center.
...
<Steps>
  ...
  <Step title="Add Your Domain in the Agency Panel" stepNumber={2} titleSize="p">
    ...
    ![Screen_004.jpg](/images/Screen_004.jpg)
  </Step>
  ...
  <Step title="Verify the Domain" stepNumber={4} titleSize="p">
    ...
    ![UO1uI7zLSY-Dni__K8faroxPrG9QNA0CFw.png](/images/UO1uI7zLSY-Dni__K8faroxPrG9QNA0CFw.png)
  </Step>
  <Step title="Go Live with Your Custom Domain" stepNumber={5} titleSize="p">
    ...
    ![P9p4-kWFnlPG9uGUsbH1sycFVGK0ZHL9nw.png](/images/P9p4-kWFnlPG9uGUsbH1sycFVGK0ZHL9nw.png)
  </Step>
</Steps>
