...
<Accordion title="Before setting up your custom domain" iconType="regular">
  ...
  - A selected subdomain (e.g., [app.yourdomain.com](http://app.yourdomain.com)) for your platform.
</Accordion>
...
<Steps>
  <Step title="Choose Your Custom Domain" stepNumber={1} titleSize="p">
    Select a subdomain like [app.yourdomain.com](http://app.yourdomain.com) to host your white-labeled platform.

    <Tip>
      **Tip:** Use a subdomain to keep your platform organized and separate from your main website (e.g., [yourdomain.com](http://yourdomain.com)).
    </Tip>
  </Step>
  <Step title="Add Your Domain in the Agency Panel" stepNumber={2} titleSize="p">
    ...
    - Enter your subdomain (e.g., [ai.yourdomain.com](http://ai.yourdomain.com)) and click **Check Status**.
  </Step>
