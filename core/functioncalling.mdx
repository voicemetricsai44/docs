...
**Actions** are the automation tools behind your voice agent. They allow your agent to **perform tasks**, not just talk, such as booking appointments, transferring calls, sending emails/SMS, and even triggering custom workflows via API.

Think of Actions as **“function blocks”** that you can link to your agent’s prompt. When the prompt calls an Action, it’s like pressing a button to get something done automatically.
