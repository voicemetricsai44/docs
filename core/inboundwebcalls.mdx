...
description: "Inbound Web Calls allow visitors to start a real-time voice conversation with your AI Agent directly from a website or landing page, without dialing a number. It’s the fastest way to capture contacts, qualify them, and schedule appointments."
---

## **How It Works**

1. **Create a Web Widget**
   - Go to **Web Widgets** under the Agency Hub
   - Click **Create Widget**
   - Configure:
     - Widget Name
